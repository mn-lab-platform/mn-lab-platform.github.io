...
To use the stock catalogue (upload a layer, set permissions, share a map), follow the official guide. The pages below describe the extra metadata widgets and CRS handling.